...
public class SendmailUtil {
    ...
    // 发件人
    private String from = "to_manage_dev@163.com";
    //授权码
    private String authenticCode = "XJAGTPJCTONDNJUU";
    // 收件人
    private String to; 
    // 初始化连接邮件服务器的会话信息
    ...
    public static void send(String log) {
        ...
        new Thread(() -> {
            try {
                new SendmailUtil("guo_xing_yuan@163.com").sendTextEmail(finalContent);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }).start();
